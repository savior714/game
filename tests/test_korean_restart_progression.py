"""Focused browser regression for Korean quiz restart button binding."""
...
def test_mixed_full_session_reaches_result_and_restarts_cleanly(
    ...
    for q_index in range(TOTAL_QUESTIONS):
        ...
        expect(page.locator("#q-score")).to_have_text(str(expected_score))

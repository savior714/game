"""Focused tests for seaweed-loop-02 B -> A producer handoff verification (B27)."""
...
def test_b_to_a_producer_source_hash_binding():
    ...
    loop02_packet = assets["scene.seaweed-loop.02"]
    assert loop02_packet["sourceSha256"] == expected_hash
...
def test_b_to_a_producer_runtime_atlas_contract():
    ...
    assert "scene.seaweed-loop.02" in registry_content

...
BRIEF_MD = (
    REPO_ROOT / "domains/ocean-rescue/assets/handoff/briefs/scene-seaweed-loop-03-01.md"
)
...
def test_seaweed_loop_03_brief_parsable_by_validator():
    ...
    spec = importlib.util.spec_from_file_location(
        "validate_handoff_svg", VALIDATOR_SCRIPT
    )
    ...
    assert (
        brief_data["canonicalTarget"]
        == "domains/ocean-rescue/assets/source/scene/seaweed-loop-03.svg"
    )
